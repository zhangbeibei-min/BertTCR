import argparse
import sys
from sklearn.metrics import accuracy_score, roc_auc_score, recall_score,f1_score,precision_recall_curve
...
def create_parser():
    ...
    parser.add_argument(
        ...
        default='/data/zhangm/BertTCR/Result/universal_prediction.tsv',
    )
    parser.add_argument(
        "--flag_positive",
        dest="flag_positive",
...
if __name__ == "__main__":
 ...
 # plot ROC curve and confusion matrix
    ...
    plt.tight_layout()
    plt.savefig('/data/zhangm/BertTCR/Picture/roc_curve_plot_universal.svg',dpi=300)  # 保存ROC曲线图像到指定路径
    ...
    plt.savefig('/data/zhangm/BertTCR/Picture/confusion_matrix_plot_universal.svg')  # 保存混淆矩阵图像到指定路径
    plt.show() 
    ...
    plt.legend(loc="lower right")
    plt.tight_layout()
    plt.savefig('/data/zhangm/BertTCR/Picture/PRC_curve_universal.jpg',dpi=300)  # 保存PRC曲线图像到指定路径
    plt.show()